            ...
            <form action="" className="p-4 ">
                ...
                <div className="flex pt-5 justify-center items-center w-full gap-3">
                    <div className="flex flex-col justify-center w-full">
                        ...
                        <input type="email" className="border-[1px] p-2 border-solid border-[#79747E] rounded-sm bg-transparent" placeholder=""/>
                    </div>
                    <div className="flex flex-col justify-center w-full">
                    ...
                    <div className="flex flex-col w-full">
                        ...
                        <div className="flex">
                            <input type={type}
                                ...
                                placeholder=""/>
                            <i className="absolute right-24 pt-2"
                                onClick={handleToggle}><Icon icon={icon}
                                    size={20}/></i>
                ...
                <div className="pt-2 pb-4 flex place-items-center w-full">
                    ...
                    <p className="flex w-full pl-2">
                        <span className="text-[] flex  ">
                            I agree to all the
                            <span className="pl-2 text-red-400">Terms
                            </span>
                            <span className="pl-2">and</span>
